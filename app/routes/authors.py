...
async def create_author(author: AuthorCreate,
                        user_data=Depends(lambda: user_has_permissions(PrivilegesEnum.MODERATOR))):
    async with async_session_maker() as session:
...
async def delete_author(author_id: int, user_data=Depends(lambda: user_has_permissions(PrivilegesEnum.MODERATOR))):
    async with async_session_maker() as session:
        try:
